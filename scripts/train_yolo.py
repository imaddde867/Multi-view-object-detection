...
def train(mode, epochs, img_size, batch_size, model_name):
    ...
    # Select Dataset
    if mode == "balanced":
        dataset_path = os.path.abspath("data/processed/data_train_balanced/dataset.yaml")
        project_name = "results/Detection_Balanced"
    elif mode == "2class":
        dataset_path = os.path.abspath("data/processed/data_train_val_test_car_person/dataset.yaml")
        project_name = "results/Detection_2Class"
    else:
